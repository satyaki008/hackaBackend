"""Standalone Terminal Demo: Data Corruption Detection & Peer Self-Healing."""
import sys
import time
import httpx
...
def main():
    print("=" * 75)
    print("  AEGISSTORE: LIVE DATA CORRUPTION DETECTION & PEER HEALING DEMO")
    print("=" * 75)
    print("  Connecting to AegisStore Controller at http://127.0.0.1:8000...")

    try:
        with httpx.Client(timeout=30.0) as client:
            resp = client.post("http://127.0.0.1:8000/api/demo/corruption-heal")
            ...
            print("\n" + "=" * 75)
            if data.get("success"):
                print("  DEMO RESULT: [SUCCESS] Tampered bytes detected and peer restored pristine SHA-256.")
